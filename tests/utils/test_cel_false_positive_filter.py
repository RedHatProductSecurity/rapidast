                ...
                "results": [
                    {
                        ...
                        "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://www.example.com/app/index.html"}}}]
                    },
                    {
                        "ruleId": "DAST-1234-KnownFP",
                        "level": "warning",
                        "message": {"text": "A known false positive issue."},
                        "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://www.example.com/app/test.php"}}}]
                    },
                    {
                        "ruleId": "CWE-200",
                        "level": "error",
                        "message": {"text": "Information exposure."},
                        "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://admin.example.com/dashboard.html"}}}]
                    },
                    {
                        "ruleId": "CWE-319",
                        "level": "warning",
                        "message": {"text": "Cleartext communication."},
                        "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://thirdparty.cdn.com/script.js"}}}]
                    },
                    {
                        "ruleId": "CWE-501",
                        "level": "note",
                        "message": {"text": "Minor style issue."},
                        "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://www.example.com/css/main.css"}}}]
                    },
                    {
                        "ruleId": "CWE-502",
                        "level": "note",
                        "message": {"text": "Minor JS issue."},
                        "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://www.example.com/js/utility.js"}}}]
                    },
                    {
                        "ruleId": "DAST-1234-KnownFP",
                        "level": "error",
                        "message": {"text": "Another known FP on admin path."},
                        "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://admin.example.com/settings.html"}}}]
                    }
                ]
            }
        ]
        ...
        "runs": [
            {
                ...
                "results": [
                    {"ruleId": "CWE-79", "level": "error", "message": {"text": "RunA kept error."}, "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://hosta.example.com/a1"}}}]},
                    {"ruleId": "DAST-1234-KnownFP", "level": "warning", "message": {"text": "RunA FP."}, "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://hosta.example.com/a2"}}}]}
                ]
            },
            {
                "tool": {"driver": {"name": "ScannerB"}},
                "results": [
                    {"ruleId": "CWE-123", "level": "error", "message": {"text": "RunB kept error1."}, "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://hostb.example.com/b1"}}}]},
                    {"ruleId": "DAST-1234-KnownFP", "level": "note", "message": {"text": "RunB FP."}, "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://hostb.example.com/b2"}}}]},
                    {"ruleId": "CWE-456", "level": "warning", "message": {"text": "RunB kept warning."}, "locations": [{"physicalLocation": {"artifactLocation": {"uri": "https://hostb.example.com/b3"}}}]}
                ]
            },
            {
                "tool": {"driver": {"name": "ScannerC"}},
                "results": []
            }
        ]
    }
...
def malformed_cel_rule():
    ...
    return FalsePositiveFiltering(
        ...
        rules=[
            FalsePositiveRule(
                name="Malformed rule",
                cel_expression='.result.level == "error" && ('
            )
        ]
    )
...
def disabled_config():
    ...
    return FalsePositiveFiltering(enabled=False, rules=[
        FalsePositiveRule(name="Some rule", cel_expression='true') # Rule exists but disabled
    ])
...
class TestCELFalsePositiveFilter:
    ...
    @pytest.mark.parametrize("result_index, expected_is_fp", [
        (0, False),
        (1, True),
        (2, True),
        (3, False),
