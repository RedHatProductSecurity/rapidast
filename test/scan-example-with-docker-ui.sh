...
# Load custom rules
docker-compose exec zaproxy_ui  python scripts/gen-zap-script/cli.py --api-key=cnmeemn7jp7ijd8rl5u14q40v8 --delete
docker-compose exec zaproxy_ui python scripts/gen-zap-script/cli.py --from-yaml scripts/gen-zap-script/rules/software_version_revealed.yaml --api-key=cnmeemn7jp7ijd8rl5u14q40v8 --load-and-enable
