...
# Load custom rules
docker-compose exec zaproxy python scripts/gen_zap_script/cli.py --rapidast-config=./config/config.yaml --delete
docker-compose exec zaproxy python scripts/gen_zap_script/cli.py --rapidast-config=./config/config.yaml --from-yaml scripts/gen_zap_script/rules/software_version_revealed.yaml --load-and-enable
